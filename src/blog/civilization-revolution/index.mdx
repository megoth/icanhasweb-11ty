...
Når dette er sagt, så har jeg troen på at Sid Meier klarer å forsere disse utfordringene med stil. Det kan f.eks. tenkes en skraping av funksjonaliteter til fordel for et enklere gameplay, og at iallefall XBox 360- og PS3-versjonen kan åpne for modifikasjoner.

Hvordan det til slutt blir har jeg lite kunnskap om, så før jeg har fått det mellom mine hender får jeg følge med den offisielle nettsiden og <a href="http://www.civfanatics.com/">en og annen civilization-fanside</a>.
