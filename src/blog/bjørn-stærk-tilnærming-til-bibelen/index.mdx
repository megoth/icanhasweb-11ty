...
Men min omtale av teksten er ikke nok til å gi bildet av hva Bjørn ønsker å formidle. Du må selv lese teksten for å få hele inntrykket. Det er absolutt noe jeg vil anbefale deg å gjøre (her er enda <a href="http://blog.bearstrong.net/articles/2007/10/07/an-atheist-reads-the-bible">en lenke</a> til teksten, om du ikke gidder å gå opp til den forrige=).
