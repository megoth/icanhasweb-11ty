...
I dag har jeg lest mye – veldig mye syns jeg. Jeg har gått gjennom listen av tweets som ble favorisert i uken som var. Noe av det hadde jeg lest tidligere, og var mer en formalitet at jeg skumleste gjennom dem for å legge dem til i delicious.

Jeg innser at mesteparten av lesingen min foregår mens jeg sitter på trikken eller banen, på vei til noe og trenger å slå av tid. Konsumeringen ellers foregår ved at jeg oppdaterer meg på twitter-tidslinjen min, og favoriserer de tweetene som lenker til sider jeg har lyst å lese. Mtp tiden jeg har brukt på å lese meg opp på de sidene i dag, så innser jeg at jeg må begrense favoriseringen min. Så får vi se hvordan uken som kommer blir.
<h2>Personlighetsvern VS utlevering av åpne data</h2>
Men resultatet av lesingen er at jeg har en liste med sider jeg gjerne vil dele. Det viktigste temaet i uken som var er saken rundt <a href="http://w2.brreg.no/enhet/sok/detalj.jsp?orgnr=988557846">Rekruttering AS</a>, som <a href="https://twitter.com/lstor">Lars Storjord</a> gjorde meg var på. Naturlig nok er det mest negativ kritikk jeg har lest.
<ul>
...
I sammenheng med dette temaet er også <a href="http://www.digi.no/878410/lonna-til-800000-personer-fritt-tilgjengelig">Lønna til 800.000 personer fritt tilgjengelig</a> interessant å lese.
...
Også aktuelt for tiden er arbeidet mot SOPA, i det den snart skal tas opp i kongressen.
<ul>
...
Det har oppstått en del oppmerksomhet rundt arbeidet med de endringene som har blitt foreslått til grunnloven.
<ul>
...
<h2>JavaScript</h2>
Har selvfølgelig lest litt fag-relevant (for meg) og.
<ul>
...
<h3>Framsia</h3>
Var på en meetup med Framsia, og så noen interessante foredrag. Har tatt frem to her.
<ul>
...
<h3>Node.js</h3>
Jeg skal innrømme at jeg ikke har satt meg så veldig inn i node.js, men uansett interessant å lese flamewars.
<ul>
