...
Min tilnærming til homofili fant jeg en del svar på hos Ars Ethicas innlegg <a href="http://arsethica.wordpress.com/2007/07/16/homohetero-kontinuumet/">Homo/hetero-kontinuumet</a>, som er første av tre deler om hans tilnærming til temaet homofili (de to andre delene oppfordres til å leses).
...
Legg merke til at jeg bevisst ikke har argumentert med noen av de anti-homofiles synspunkter på homofili, rett og slett fordi jeg ikke støtter de aller fleste av deres synspunkter (om du skulle være interessert i å lese mer om noen av dem, anbefaler jeg å startepå Martins side med <a href="http://martindrange.abcblogg.no/080806224646_homofiles_rettigheter.html">Homofiles “rettigheter”</a>).
